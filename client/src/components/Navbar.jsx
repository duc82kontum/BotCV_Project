    ...
    <div className='shadow py-4 bg-white sticky top-0 z-50'>
      <div className='container px-4 2xl:px-20 mx-auto flex justify-between items-center'>
        ...
        <div className='flex items-center gap-4'>
          ...
          {/* PHẦN LOGIC HIỂN THỊ KHI ĐÃ ĐĂNG NHẬP */}
          {token && userData ? (
            <div className='flex items-center gap-4'>
              
              {/* 1. NÚT QUAY LẠI DASHBOARD (Chỉ dành cho Nhà tuyển dụng) */}
              {role === 'recruiter' && (
                <button 
              ...
              {/* 2. MENU ĐIỀU HƯỚNG CHO USER (Ẩn nếu là Recruiter) */}
              {role === 'user' && (
              ...
              <div className='group relative flex items-center gap-2 cursor-pointer'>
                ...
                <div className='hidden sm:block'>
                   ...
                   <p className='text-xs font-bold text-gray-700 truncate max-w-[100px]'>
                     {userData.fullName || userData.name || 'Tài khoản'}
                   </p>
                </div>
